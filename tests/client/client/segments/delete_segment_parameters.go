...
// WithSlug adds the slug to the delete segment params
func (o *DeleteSegmentParams) WithSlug(slug string) *DeleteSegmentParams {
	o.SetSlug(slug)
	return o
}

// SetSlug adds the slug to the delete segment params
func (o *DeleteSegmentParams) SetSlug(slug string) {
	o.Slug = slug
}
